...
<template>
    <article
        class="prose dark:prose-invert prose-a:decoration-wavy prose-a:decoration-green-800 dark:prose-a:decoration-green-400 prose-headings:scroll-mt-20 prose-h1:text-green-800 dark:prose-h1:text-green-400 prose-p:text-justify markdown prose-blockquote:prose-p:first-of-type:after:content-none prose-blockquote:prose-p:first-of-type:before:content-none prose-code:before:content-none prose-code:after:content-none not-prose-pre:prose-code:bg-(--bg-color) dark:not-prose-pre:prose-code:bg-(--text-color) not-prose-pre:prose-code:text-(--text-color) dark:not-prose-pre:prose-code:text-(--bg-color) not-prose-pre:prose-code:rounded-sm not-prose-pre:prose-code:p-1 text-inherit bg-amber-400 prose-blockquote:prose-p:opacity-50 prose-strong:font-extrabold prose-strong:text-green-800 dark:prose-strong:font-extrabold dark:prose-strong:text-green-400 prose-p prose-pre:bg-(--bg-color) prose-pre:bg(--text-color) dark:prose-pre:bg-(--text-color) dark:prose-pre:text-(--bg-color) dark:prose-pre:bg-(--text-color) dark:prose-pre:text-(--bg-color) prose-blockquote:quotes prose-blockquote:border-l-green-800 dark:prose-blockquote:border-l-green-400 prose-li:marker:text-green-800 dark:prose-li:marker:text-green-400 w-full h-full">
        <div v-html="html" class="w-full h-full bg-green-500"/>
    </article>
</template>
